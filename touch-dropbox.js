...
//{receiverUrl: "http://localhost:8081/pm.html"}));
//client.authDriver(new Dropbox.AuthDriver.NodeServer(8081));
...
$( document ).ready(function(){
    ...
    msg+='<br></div>';
    //
    //console.log(computeCombinations(storyBank, 4));
    //$("#gamepage").bind('pageshow', function() {
    //	alert(1);
    	//document.getElementById('game-password').focus();
    //    $('#gamestories').find('#game-password').focus();
    //    alert(2);
    //});
